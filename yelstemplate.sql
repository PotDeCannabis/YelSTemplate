...
-- Généré le :  Sam 28 Mai 2022 à 17:07
...
CREATE TABLE `dpkeybinds` (
  ...
  `keybind1` varchar(50) NOT NULL DEFAULT 'num4',
  `emote1` varchar(255) NOT NULL DEFAULT '',
  `keybind2` varchar(50) NOT NULL DEFAULT 'num5',
  `emote2` varchar(255) NOT NULL DEFAULT '',
  `keybind3` varchar(50) NOT NULL DEFAULT 'num6',
  `emote3` varchar(255) NOT NULL DEFAULT '',
  `keybind4` varchar(50) NOT NULL DEFAULT 'num7',
  `emote4` varchar(255) NOT NULL DEFAULT '',
  `keybind5` varchar(50) NOT NULL DEFAULT 'num8',
  `emote5` varchar(255) NOT NULL DEFAULT '',
  `keybind6` varchar(50) NOT NULL DEFAULT 'num9',
  `emote6` varchar(255) NOT NULL DEFAULT ''
...
('medikit', 'Kit de soin', 5, 0, 1),
('milk', 'Lait', 10, 0, 1),
('phone', 'Téléphone', 1, 0, 1),
('sandwich', 'Sandwich', 10, 0, 1),
('water', 'Bouteille d\'eau', 10, 0, 1);
...
ALTER TABLE `dpkeybinds`
  ADD PRIMARY KEY (`id`,`keybind1`,`emote1`,`keybind2`,`emote2`,`keybind3`,`emote3`,`keybind4`,`emote4`,`keybind5`,`emote5`,`keybind6`,`emote6`);
